...
function woosq_thumbnails_slick() {
  if (jQuery('#woosq-popup .thumbnails-ori .images .thumbnail').length > 1) {
    if (jQuery('#woosq-popup .thumbnails-ori .images').
        hasClass('slick-initialized')) {
      // unslick first
      jQuery('#woosq-popup .thumbnails-ori .images').slick('unslick');
    }

    jQuery('#woosq-popup .thumbnails-ori .images').
